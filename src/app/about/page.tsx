...
import { MapPin, Mail, Github, Linkedin, Gamepad2 } from "lucide-react";
...
export default function AboutPage() {
  ...
  const socialLinks = [
    ...
    {
      name: "Steam",
      href: "https://steamcommunity.com/profiles/76561198360047005/",
      icon: Gamepad2,
      displayText: "Steam Profile",
    },
  ];
          ...
          <div className="flex justify-center">
            <div className="relative w-full max-w-6xl">
              <Image
                ...
                width={1200}
                height={630}
                className="rounded-lg shadow-lg w-full h-auto object-cover brightness-110 contrast-90"
                priority
              />
            </div>
          </div>
